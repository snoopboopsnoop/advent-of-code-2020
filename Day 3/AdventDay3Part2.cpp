...
int main() {
  ...
  count = algorithm(inputArray, 1, 1, inputLength, inputWidth);
  count *= algorithm(inputArray, 3, 1, inputLength, inputWidth);
  count *= algorithm(inputArray, 5, 1, inputLength, inputWidth);
  count *= algorithm(inputArray, 7, 1, inputLength, inputWidth);
  count *= algorithm(inputArray, 1, 2, inputLength, inputWidth);
  cout << fixed;
  cout << count << endl;
  return 0;
}
